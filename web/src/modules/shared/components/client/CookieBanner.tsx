  ...
  return (
    <div className='fixed bottom-0 w-full h-32 z-10 flex justify-center bg-blue-900/80 border-t-blue-500/80 border-t-4 border-zinc-700 backdrop-blur-md p-4'>
      <div className='w-screen-xl'>
        {/* Close button */}
        <button className='absolute top-2 right-2 text-lg text-zinc-400'>
          <FontAwesomeIcon icon={faClose} />
        </button>
        <FontAwesomeIcon
          icon={faCookieBite}
          className='text-2xl text-blue-500 w-6 h-6'
        />
        ...
        <div className='flex justify-end'>
          <button className='justify-self-end text-sm bg-blue-600 hover:bg-blue-500 px-3 py-1.5 rounded-lg'>
            Got it!
          </button>
        </div>
      </div>
